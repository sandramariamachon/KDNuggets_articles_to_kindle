...
f.write("<a href='#anchor-name'>" + "Jump to the part of the page with the “anchor-name” id" + "</a>")   
f.write("<h1>" + title + "</h1>")   
for p in p_list:
    f.write(p.get_text()+"\n\n")
f.write("<h1>" + title + "</h1>")   
...
This is link to converting html2mobi and sending it to an email: https://github.com/moshfiqur/html2mobi 🍬
"""
